        ...
        changes: [
            {
                ...
                dummy_answers: ["ボールの色が変わった", "バッグの数が増えた", "空の色が変わった"]
            },
            {
            ...
            },
            {
                ...
                correct_answer: "バッグが猫になった",
                dummy_answers: ["服装が変わった", "ボールが減った", "選手の帽子が変わった"]
            },
            {
                change_image: "images/baseball_q4.webp",
                correct_answer: "バックが消えた",
                dummy_answers: ["UFOが消えた", "ボールが減った", "グローブの色が変わった"]
            }
        ]
    },
        ...
        changes: [
            {
                ...
                dummy_answers: ["床の色が変わった", "監視カメラが消えた", "眼の色が変わった"]
            },
            {
            ...
            },
            {
                ...
                dummy_answers: ["床の色が変わった", "猫の耳の色が変わった", "エレベーターのボタンが消えた"]
            },
            {
                change_image: "images/cat_q4.webp",
                correct_answer: "後ろに柴犬が現れた",
                dummy_answers: ["床の色が変わった", "監視カメラが消えた", "猫の耳の色が変わった"]
            }
        ]
    },
        ...
        changes: [
            {
                ...
                dummy_answers: ["右端の男性の髪型が変わった", "背景のバスが消えた", "全員の身長が変わった"]
            },
            {
            ...
            },
            {
                ...
                dummy_answers: ["右端の男性の髪型が変わった", "背景のバスが消えた", "左から2番目の男性の服の色が変わった"]
            }
        ]
    },
        ...
        changes: [
            {
                ...
                dummy_answers: ["壺が消えた", "黒子のポーズが変わった", "畳の色が変わった"]
            },
            {
                change_image: "images/kuroko_q2.webp",
                correct_answer: "襖が消えた",
                dummy_answers: ["掛け軸の文字が変わった", "壺が消えた", "障子の模様が変わった"]
            },
            {
                change_image: "images/kuroko_q3.webp",
                correct_answer: "壺が現れた",
                dummy_answers: ["黒子のポーズが変わった", "掛け軸の文字が変わった", "壁の色が変わった"]
            },
            {
                change_image: "images/kuroko_q4.webp",
                correct_answer: "黒子がお面をつけた",
                dummy_answers: ["壺が消えた", "黒子のポーズが変わった", "掛け軸の文字が変わった"]
            }
        ]
    },
    ...
    // --- お題6: 腕が伸びる男 ---
    {
        ...
        changes: [
            ...
            },
            {
                ...
                dummy_answers: ["床の模様が変わった", "赤い服が消えた", "壁の色が変わった"]
            },
            {
                change_image: "images/luffy_q3.webp",
                correct_answer: "赤い服の男性になった",
                dummy_answers: ["床の模様が変わった", "透明人間が一瞬見えた", "腕の長さが変わった"]
            },
            {
                change_image: "images/luffy_q4.webp",
                correct_answer: "車が現れた",
                dummy_answers: ["床の模様が変わった", "服の色が変わった", "腕の長さが変わった"]
            }
        ]
    },
        ...
        changes: [
            {
                ...
                correct_answer: "ネクタイの色が変わった",
                dummy_answers: ["壁の色が変わった", "スーツの色が変わった", "髪型が変わった"]
            },
            {
                change_image: "images/press_q2.webp",
                correct_answer: "背景にポスターが現れた",
                dummy_answers: ["ネクタイの色が変わった", "表情が変わった", "スーツの色が変わった"]
            },
            {
                change_image: "images/press_q3.webp",
                correct_answer: "背景が紫色になった",
                dummy_answers: ["ネクタイの色が変わった", "表情が変わった", "スーツの種類が変わった"]
            },
            {
                change_image: "images/press_q4.webp",
                correct_answer: "給食が現われた",
                dummy_answers: ["ネクタイの色が変わった", "背景のポスターが消えた", "何も変わってない"]
            }
        ]
    },
        ...
        changes: [
            {
                ...
                dummy_answers: ["ぬいぐるみが消えた", "ベッドが質素になった", "ポスターの絵柄が変わった"]
            },
            {
            ...
            },
            {
                ...
                dummy_answers: ["鳥が消えた", "ゲーム機が変わった", "壁の色が変わった"]
            },
            {
                change_image: "images/room_q4.webp",
                correct_answer: "ゲーム機が消えた",
                dummy_answers: ["鳥が消えた", "ベッドが質素になった", "枕元のぬいぐるみが変わった"]
            }
        ]
    },
        ...
        changes: [
            {
                ...
                dummy_answers: ["髪型が変わった", "ソファの色が変わった", "短パンの色が変わった"]
            },
            {
                change_image: "images/yaju_q2.webp",
                correct_answer: "ソファに誰もいなくなった",
                dummy_answers: ["Tシャツの色が変わった", "表情が変わった", "壁の色が変わった"]
            },
            {
                change_image: "images/yaju_q3.webp",
                correct_answer: "後ろに別の人物が現れた",
                dummy_answers: ["Tシャツの色が変わった", "ソファの色が変わった", "ソファの布が無くなった"]
            },
            {
                change_image: "images/yaju_q4.webp",
                correct_answer: "髪型が変わった",
                dummy_answers: ["Tシャツの色が変わった", "短パンの色が変わった", "ソファの色が変わった"]
            }
        ]
    }
];